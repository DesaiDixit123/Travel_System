...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-3 font-weight-bold">Corporate Dashboard</span>
    </a>
  </div>
...
<li class="nav-item">
    <a class="nav-link {{ (Request::is('Corporate-Details') ? 'active' : '') }}" href="{{ url('Corporate-Details') }}">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 46 42" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd">
                    <g transform="translate(-1717, -291)" fill="#FFFFFF">
                        <g transform="translate(1716, 291)">
                            <g transform="translate(1, 0)">
                                <path class="color-background" d="M45,0 L26,0 C25.447,0 25,0.447 25,1 L25,20 C25,20.379 25.214,20.725 25.553,20.895 C25.694,20.965 25.848,21 26,21 C26.212,21 26.424,20.933 26.6,20.8 L34.333,15 L45,15 C45.553,15 46,14.553 46,14 L46,1 C46,0.447 45.553,0 45,0 Z" opacity="0.6"></path>
        ...
        <span class="nav-link-text ms-1">Corporate Details</span>
    </a>
</li>

@endif

{{-- Show this to both Admin and Corporate --}}
@if(session('user_role') === 'admin' || session('user_role') === 'corporate')
<li class="nav-item pb-2">
    <a class="nav-link {{ (Request::is('Employees') ? 'active' : '') }}" href="{{ url('Employees') }}">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center {{ (Request::is('Employees') ? 'text-white' : 'text-dark') }}"></i>
        </div>
...
<li class="nav-item">
    <a class="nav-link {{ (Request::is('Quotations') ? 'active' : '') }}" href="{{ url('Quotations') }}">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 46 42" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd">
                    <g transform="translate(-1717, -291)" fill="#FFFFFF">
